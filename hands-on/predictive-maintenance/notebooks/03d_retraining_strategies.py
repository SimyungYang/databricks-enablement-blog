...
# MAGIC   - Data Quality Monitoring(구 Data Quality Monitoring)으로 자동 성능 추적 구축 완료 시
# MAGIC ```
# MAGIC
...
# MAGIC                 Yes                No
# MAGIC                  │                  │
# MAGIC            24시간 이내?        센서 데이터 실시간?
# MAGIC            /         \          /          \
# MAGIC          Yes          No      Yes           No
# MAGIC           │           │        │             │
# MAGIC      성능 기반     하이브리드  드리프트 기반  스케줄 기반
# MAGIC      (전략 2)     (전략 4)    (전략 3)      (전략 1)
# MAGIC ```
